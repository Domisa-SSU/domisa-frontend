        ...
        <Article title="제6조 (서비스 이용 시간 및 종료)">
          <OrderedList>
            <li>
              서비스는 다음 기간 동안 제공됩니다.
              <BulletList>
                <li>무료/유료 기능 운영: 2026. 05. 13. 10:00 ~ 2026. 05. 15. 23:59</li>
                <li>최종 서비스 종료: 2026. 10. 15. 23:59</li>
              </BulletList>
            </li>
      ...
      <Chapter title="제3장 유료 결제 및 환불">
        <Article title="제8조 (쿠키의 관리 및 소멸)">
          <BulletList>
            ...
            <li>쿠키는 서비스 이용기간(~2026. 05. 15) 이후에는 사용이 불가합니다.</li>
          </BulletList>
        </Article>
              ...
              <OrderedList>
                <li>
                  ...
                  <OrderedList>
                    ...
                    <li>운영 기간 종료: 본 서비스는 축제 한정 서비스로, 서비스 운영 기간(2026. 05. 13. ~ 2026. 05. 15.) 내에 사용하지 않은 쿠키는 기간 경과와 함께 효력이 소멸하며 환불 대상에서 제외됩니다.</li>
