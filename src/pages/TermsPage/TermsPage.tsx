    ...
    <>
      <Chapter title="제1장 총칙">
        <Article title="제1조 (목적)">
          <Paragraph>
            본 이용약관은 도미사 (이하 “회사”)에서 제공하는 도미사럽 서비스
            (이하 “서비스”)의 이용과 관련하여 적용되는 것으로 회사와 이용자에게
            적용됩니다. 본 약관은 서비스 이용에 관한 권리 및 의무와 책임사항, 기타
        ...
        <Article title="제2조 (용어의 정의)">
          ...
          <OrderedList>
            ...
            <li>
              회원가입: 회원이 “도미사” 서비스를 이용하기 위해 카카오 로그인 이후
              성별, 출생연도, 닉네임을 입력하여 서비스에 가입하는 것을 의미합니다.
      ...
      <Chapter title="제2장 이용계약 및 서비스 이용">
        <Article title="제5조 (이용계약의 성립 및 해지)">
          <OrderedList>
            <li>이용계약은 이용자가 약관에 동의하고 가입 절차를 완료함으로써 성립됩니다.</li>
            <li>회원은 언제든지 서비스 내 기능을 통해 자신의 프로필을 삭제하거나 탈퇴를 요청할 수 있습니다.</li>
        ...
        <Article title="제6조 (서비스 이용 시간 및 종료)">
          <OrderedList>
            <li>
              서비스는 다음 기간 동안 제공됩니다.
              <BulletList>
                <li>무료/유료 기능 운영: 2026. 09. 14. 12:00 ~ 2026. 09. 17. 23:59</li>
              </BulletList>
            </li>
        ...
        <Article title="제7조 (서비스의 내용)">
          ...
          <BulletList>
            ...
            <li>
              ‘소개팅 카드 즉시 갱신(카드섞기)’ 기능: 2시간의 대기 시간이 경과하기 전,
      ...
      <Chapter title="제3장 유료 결제 및 환불">
        <Article title="제8조 (쿠키의 관리 및 소멸)">
          <BulletList>
            ...
            <li>쿠키는 서비스 이용 기간(~2026. 09. 17. 23:59) 이후에는 사용이 불가합니다.</li>
          </BulletList>
        </Article>

        <Article title="제9조 (결제 및 환불 규정)">
          <div className="flex flex-col gap-1">
            <Paragraph>① 이용자는 서비스 내의 결제시스템을 통해 유료 재화(쿠키)를 구매할 수 있으며, 결제가 비정상적으로 처리되어 정상 처리를 요청할 경우 회사는 이용자의 결제금액을 정상 처리할 의무를 집니다.</Paragraph>
            <Paragraph>② 회사는 부정한 방법 또는 회사가 금지한 방법을 통해 충전 및 결제된 금액에 대해서는 이를 취소하거나 환불을 제한할 수 있습니다.</Paragraph>
            <Paragraph>③ 본 서비스의 결제는 ‘상대방 정보 제공’ 및 ‘매칭 기회 제공’이라는 디지털 콘텐츠 및 용역에 대한 대가입니다. 매칭 성공 후 실제 연락 여부나 만남 성사 여부 등 이용자 간의 주관적 영역에 대해서는 회사가 보상하거나 책임지지 않습니다.</Paragraph>
            <Paragraph>④ 이용자는 다음 각 호의 사유가 있는 경우 아래 규정에 따라 회사로부터 결제 취소, 환불 및 보상을 받을 수 있습니다.</Paragraph>
            <OrderedList>
              <li>결제를 통해 사용할 수 있는 서비스가 전무하며 그에 대한 책임이 전적으로 회사에 있을 경우(단, 시스템 정기 점검 등의 불가피한 사유로 인한 경우는 제외)</li>
              <li>서비스 중단 등 회사의 중대한 과실로 인해 이용자에게 정상적인 서비스 제공이 불가능한 경우</li>
            </OrderedList>
            <Paragraph>⑤ 이용자가 쿠키를 구매한 후 제6조 제1항에 따른 서비스 이용 기간 내 사용하지 않은 경우, 해당 쿠키는 서비스 종료일(2026년 9월 17일 23:59) 이후 자동 소멸되며 환불 대상에서 제외됩니다.</Paragraph>
            <Paragraph>⑥ 다음 각 호에 해당하는 경우, 디지털 콘텐츠의 특성 및 단기 서비스 운영 정책에 따라 환불이 불가합니다.</Paragraph>
            <OrderedList>
              <li>디지털 재화의 사용: 이용자가 쿠키를 구매한 후 이를 1개라도 사용하여 상대방의 프로필을 열람하거나 ‘호감 보내기’, ‘카드섞기’ 등 유료 기능을 실행한 경우. 또한 구매한 쿠키 중 일부를 사용한 경우에도 전체 및 잔여분에 대한 부분 환불은 불가합니다.</li>
              <li>이용자 귀책에 의한 서비스 중단: 이용자가 본인의 의사로 프로필을 삭제하거나 계정을 탈퇴하여 서비스 이용 권한을 포기한 경우</li>
              <li>운영 정책 위반: 이용약관 제11조(이용자의 의무)를 위반하여 부정행위, 허위 정보 기재, 타인 비방 등으로 인해 서비스 이용이 제한되거나 강제 탈퇴 조치된 경우</li>
            </OrderedList>
            <Paragraph>⑦ 환불을 원하는 이용자는 결제일로부터 7일 이내에 사용하지 않은 쿠키에 한하여 회사 인스타그램 또는 이메일을 통해 이용자 본인임을 인증하는 절차를 거쳐 신청할 수 있습니다.</Paragraph>
            <Paragraph>⑧ 회사의 정책상 환불 사유에 해당할 경우 회사는 이용자에게 환불을 위한 일정한 절차 및 환불 입금 계좌번호 등의 금융정보를 요청할 수 있습니다. 이용자가 이에 정보를 제공하는 경우에 한해 환불이 가능하며, 이용자는 환불 요청 시 이러한 개인정보 제공에 동의하는 것으로 간주합니다.</Paragraph>
            <Paragraph>⑨ 신원 인증 과정에서 이용자의 등록 정보가 허위 정보로 판명되거나 대학(원) 재·휴학생 등 서비스 이용 조건에 부합되지 않는 것이 판명될 경우 강제 이용 중지 또는 영구 이용 중지 조치가 되며, 이용자 본인의 귀책사유로 인한 것이므로 환불 및 보상이 불가능합니다.</Paragraph>
            <Paragraph>⑩ 분쟁 해결: 회사와 이용자 간 발생한 분쟁은 관련 법령에 따라 전자거래분쟁조정위원회의 조정을 따를 수 있습니다.</Paragraph>
          </div>
        </Article>
      </Chapter>
      ...
      <Chapter title="제4장 계약 당사자의 의무">
        <Article title="제10조 (회사의 의무)">
          <OrderedList>
            ...
            <li>회사는 직무상 알게 된 회원의 개인정보를 제3자에게 누설하지 않습니다. 단, 쌍방 매칭이 성사된 경우 상호 연락처가 공개되는 것은 예외로 하며, 이에 관한 사항은 개인정보처리방침에 따릅니다.</li>
          </OrderedList>
        </Article>
      ...
      <Chapter title="제5장 기타 사항">
        ...
        <Article title="부칙">
          <Paragraph>본 약관은 2026년 9월 14일부터 시행됩니다.</Paragraph>
        </Article>
      </Chapter>
    </>
  );
  ...
  return (
    <>
      <Chapter title="개인정보 수집 및 이용 동의">
        ...
        <Article title="5. 개인정보 보호 책임자 안내">
          <BulletList>
            <li>책임자: 도미사 운영팀</li>
            <li>
              이메일:{" "}
